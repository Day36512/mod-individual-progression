...
enum Spells
{
    SPELL_POISON_CLOUD = 828240,
    SPELL_MUTATING_INJECTION = 828169,
    SPELL_MUTATING_EXPLOSION = 828206,
    SPELL_SLIME_SPRAY = 828157,
    SPELL_POISON_CLOUD_DAMAGE_AURA = 828158,
    SPELL_BERSERK = 26662,
    SPELL_BOMBARD_SLIME = 828280
};
    ...
    struct boss_grobbulus_40AI : public BossAI
    {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_MUTATING_INJECTION:
                ...
                events.RepeatEvent(20000); // Schedule the next injection to occur after 20 seconds
                break;
            }
...
{
public:
    spell_grobbulus_mutating_injection_40() : SpellScriptLoader("spell_grobbulus_mutating_injection_40") { }
